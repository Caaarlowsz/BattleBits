...
public final class AccountAPI {
	...
	public static final void addBattlePlayerXp(final Player bp, final int xp) {
		int bpstatus = AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp");
		AccountFile.getAccountsFile().set(
				AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp",
				bpstatus + xp);
		XpAPI.addXp(bp, xp);
		AccountFile.saveAccountsFile();
	}
	...
	public static final void addBattlePlayerXp(final OfflinePlayer bp, final int xp) {
		int bpstatus = AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp");
		AccountFile.getAccountsFile().set(
				AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp",
	...
	public static final void removeBattlePlayerXp(final Player bp, final int xp) {
		int bpstatus = AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp");
		AccountFile.getAccountsFile().set(
				AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp",
	...
	public static final void removeBattlePlayerXp(final OfflinePlayer bp, final int xp) {
		int bpstatus = AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp");
		AccountFile.getAccountsFile().set(
				AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp",
	...
	public static final void removeBattlePlayerCash(final OfflinePlayer bp, final int cash) {
		int bpstatus = AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Cash");
		AccountFile.getAccountsFile().set(
				AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Cash",
	...
	public static final int getBattlePlayerKills(final Player bp) {
		return AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Kills");
	}

	public static final int getBattlePlayerDeaths(final Player bp) {
		return AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Deaths");
	}

	public static final int getBattlePlayerKillStreak(final Player bp) {
	...
	public static final int getBattlePlayerKills(final OfflinePlayer bp) {
		return AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Kills");
	}

	public static final int getBattlePlayerDeaths(final OfflinePlayer bp) {
		return AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Deaths");
	}
	...
	public static final int getBattlePlayerXp(final OfflinePlayer bp) {
		return AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Xp");
	}

	public static final int getBattlePlayerCash(final OfflinePlayer bp) {
		return AccountFile.getAccountsFile()
				.getInt(AccountConstructor.Prefix + BattlePlayerAPI.getBattlePlayerName(bp).toLowerCase() + ".Cash");
	}
